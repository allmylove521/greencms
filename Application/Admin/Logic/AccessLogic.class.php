...
//     	var_dump($_POST);
        ...
        $data ['user_tel_number'] = $_POST ['user_tel_number'];
        $data ['user_discipline_item'] = $_POST ['user_discipline_item'];
        $data ['user_department_level'] = $_POST ['user_department_level'];
        $data ['user_nation'] = $_POST ['user_nation'];
        $data ['user_identity_card'] = $_POST ['user_identity_card'];
        $data ['user_political_status'] = $_POST ['user_political_status'];
        $data ['user_first_education_school'] = $_POST ['user_first_education_school'];
        $data ['user_first_education_level'] = $_POST ['user_first_education_level'];
        $data ['user_high_education_school'] = $_POST ['user_high_education_school'];
        $data ['user_high_education_level'] = $_POST ['user_high_education_level'];
